...
class SqzfController extends Controller {
    ...
    async getPersonsnums() {
        ...
        const { ctx } = this;
        const keywords = ctx.request.url.split('=')[1];
        console.log( keywords,'hhhhhhhhhhhhhh');
        let url = `https://www.sqfcw.com/wapi/im/chatFriends.html?page=1&rows=20&is_black=0&keywords=${keywords}`
        let refererUrl = "https://www.sqfcw.com/m/pages/index/chat_list";
        let ip = returnIp();
        // console.log(ip, '----')
        let result = await ctx.curl(url, {
    ...
    async getLanguage() {
        ...
        let url = `https://www.sqfcw.com/wapi/im/expressLanguage.html?to_id=16635`;
        let refererUrl = "https://www.sqfcw.com/m/chatPage/chat/chat?title=%E6%A2%A8%E5%9B%AD%E6%B9%BE-%E9%9F%A9%E4%B8%B9&to_id=tfy_d69570cdcfe264ce_16635&user_id=16635";
        let ip = returnIp();
        console.log(ip, '----')
        let result = await ctx.curl(url, {
            method: 'GET',
        ...
        if (result.status === 302) {
            ctx.body = await ctx.curl(url, {
                ...
                headers: {
                    ...
                    "referer": refererUrl,
                    "authorization": "eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJvcGVuaWQiOjY3OTcxLCJ1aWQiOjY3OTcxLCJ0aW1lIjoxNjM2MTExOTk4fQ.IvmpnjzyrP8hvzF1gPDxcBh-_IYAAa0I8ZEQHVk7qII",
                    "cookie":"UM_distinctid=17ca7a9010b143-0ed64ecaef8066-39664306-144000-17ca7a9010c63f; CNZZDATA1278924275=1855832823-1634900443-%7C1634900443; Hm_lvt_b62b1005764f95fe323dcaab3ae37284=1635381391,1635464080,1635471350,1635552330; Hm_lpvt_b62b1005764f95fe323dcaab3ae37284=1635552334"
                },
            });
        }
        result.data = JSON.parse(result.data.toString())
    ...
    async getPhotos() {
        ...
        const id = ctx.request.url.slice(24, 30);
        console.log(ctx.request.url.slice(24, 30), '222222222222222222222222222');
        let url = `https://www.sqfcw.com/wapi/adviser/seeMeList?id=748`;
        let refererUrl = "https://www.sqfcw.com/m/user/consultant/seeme?id=748";
        let ip = returnIp();
        console.log(ip, '----')
        let result = await ctx.curl(url, {
            method: 'GET',
        ...
        if (result.status === 302) {
            ctx.body = await ctx.curl(url, {
                ...
                headers: {
                    ...
                    "referer": refererUrl,
                    "authorization": "eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJvcGVuaWQiOjY3OTcxLCJ1aWQiOjY3OTcxLCJ0aW1lIjoxNjM2MTExOTk4fQ.IvmpnjzyrP8hvzF1gPDxcBh-_IYAAa0I8ZEQHVk7qII",
                    "cookie":"UM_distinctid=17ca7a9010b143-0ed64ecaef8066-39664306-144000-17ca7a9010c63f; CNZZDATA1278924275=1855832823-1634900443-%7C1634900443; Hm_lvt_b62b1005764f95fe323dcaab3ae37284=1635471350,1635552330,1635725330,1635812215; Hm_lpvt_b62b1005764f95fe323dcaab3ae37284=1635812215"
                },
            });
        }
        result.data = JSON.parse(result.data.toString())
    ...
    async getLike() {
        ...
        console.log(ctx.request.url.split('=')[1], 'qqqqqqqqqqqqqqqqqqqqqqqq');
        let url = `https://www.sqfcw.com/wapi/adviser/adv_addstar?id=${id}`;
        let refererUrl = `https://www.sqfcw.com/m/pages/consultant/detail?id=${id}`;
        let ip = returnIp();
        console.log(ip, '----')
        let result = await ctx.curl(url, {
            method: 'GET',
        ...
        if (result.status === 302) {
            ctx.body = await ctx.curl(url, {
                ...
                headers: {
                    ...
                    "referer": refererUrl,
                    "authorization": "eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJvcGVuaWQiOjY3OTcxLCJ1aWQiOjY3OTcxLCJ0aW1lIjoxNjM2MTExOTk4fQ.IvmpnjzyrP8hvzF1gPDxcBh-_IYAAa0I8ZEQHVk7qII",
                    "cookie":"UM_distinctid=17ca7a9010b143-0ed64ecaef8066-39664306-144000-17ca7a9010c63f; CNZZDATA1278924275=1855832823-1634900443-%7C1634900443; Hm_lvt_b62b1005764f95fe323dcaab3ae37284=1635552330,1635725330,1635812215,1635814977; Hm_lpvt_b62b1005764f95fe323dcaab3ae37284=1635816598"
                },
            });
        }
        result.data = JSON.parse(result.data.toString())
